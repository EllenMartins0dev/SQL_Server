...
SELECT TOP 3 * 
FROM Biblioteca.dbo.Genero;

-- 5. Seleciona clientes e seus endereços no bairro "Centro"
SELECT cli.codigo_cliente, cli.nome, clie.bairro  FROM Biblioteca.dbo.Clientes_Enderecos clie
INNER JOIN Biblioteca.dbo.Clientes cli 
...
FROM Biblioteca.dbo.Estoque est
INNER JOIN Biblioteca.dbo.Livros liv 
    ON liv.codigo_livro = est.codigo_livro
INNER JOIN Biblioteca.dbo.Movimentacao_Estoque mov 
